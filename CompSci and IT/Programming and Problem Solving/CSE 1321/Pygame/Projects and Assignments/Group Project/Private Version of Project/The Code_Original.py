...
bonfire_scaled = pygame.transform.scale(bonfire_image, (70,66))
bonfire = pygame.transform.rotate(bonfire_scaled, -44)

    # bonfire 2
bonfire_image1 = pygame.image.load("bonfire image.png")
bonfire_scaled1 = pygame.transform.scale(bonfire_image1, (75,75))
bonfire1 = pygame.transform.rotate(bonfire_scaled1, -42)
...
class Dragon(pygame.sprite.Sprite):
    def __init__(self,color,x,y):  # the basic properties of the Dragon
        super().__init__()
        dragon_image = pygame.image.load("user dragon image.png")
        self.image = pygame.transform.scale(dragon_image, (95,95))
...
class Hero(pygame.sprite.Sprite):
    def __init__(self,color):
        ...
        self.image = pygame.transform.scale(hero_image, (35,50))
    ...
    def follow_dragon(self, dragon_x, dragon_y):   # when called, allows for the Heroes to move according to specific requirements defined below
        ...
        if showInstructions or game_over:            # stops movement while the instructions screen is visible  / when the user has died
...
class Fireball(pygame.sprite.Sprite):
    def __init__(self,color,x,y):
        ...
        self.image = pygame.transform.scale(fireball_image, (50,50))
...
while running:
    ...
    screen.blit(bonfire, (144,166))
    screen.blit(bonfire1, (98,62))
    ...
    if showInstructions:
        ...
        screen.blit(inst7s, (20, 300))
        screen.blit(inst8s, (20, 320))
        screen.blit(inst9s, (20, 348))
        screen.blit(inst10s, (20, 360))
